...
class ReportAccountReportControlXslx(models.AbstractModel):
    _name = 'report.report_account_report_control_xlsx'
    _inherit = 'report.account_report_control.abstract_report_xlsx'

    def _get_report_name(self):
        return _('Account Report Control')
