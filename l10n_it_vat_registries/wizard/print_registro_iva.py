...
class wizard_registro_iva(models.TransientModel):
    ...
    def print_registro(self, cr, uid, ids, context=None):
        ...
        datas['form'] = {}
        datas['form']['fiscal_page_base'] = wizard.fiscal_page_base
        datas['form']['period_ids'] = [p.id for p in wizard.period_ids]
        datas['form']['tax_sign'] = wizard.tax_sign
        report_name = False
        if wizard.type == 'customer':
            report_name = 'registro_iva_vendite'
        elif wizard.type == 'supplier':
            report_name = 'registro_iva_acquisti'
        elif wizard.type == 'corrispettivi':
            report_name = 'registro_iva_corrispettivi'
